...
namespace Drkb.UniversalBot.Infrastructure.Data.DataProviders.Statistics;

public class EFCreateStatisticsDataProvider: ICreateStatisticsDataProvider
{
    private readonly BotDbContext _context;

    public EFCreateStatisticsDataProvider(BotDbContext context)
    {
        _context = context;
    }
